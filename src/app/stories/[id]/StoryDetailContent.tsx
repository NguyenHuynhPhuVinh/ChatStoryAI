    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-[300px_1fr] gap-8 mb-8">
          ...
          >
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-slate-700/50 p-4">
              <div className="relative w-full aspect-[3/4] rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100 via-purple-50 to-indigo-100 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-indigo-900/20">
                {story.cover_image ? (
                  <Image
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge
                variant="default"
                className="text-sm truncate max-w-[200px] leading-relaxed"
              >
                {story.main_category}
              </Badge>
                    ...
                    characters
                      ...
                      .map((character) => (
                        <Card
                          ...
                          className="flex flex-col sm:flex-row items-center sm:items-start p-3 sm:p-6"
                        >
                          ...
                          <div className="flex-grow min-w-0 mt-3 sm:mt-0 sm:ml-6 text-center sm:text-left w-full sm:w-auto">
                            <CardTitle className="text-xl sm:text-2xl truncate px-4 sm:px-0">
                              {character.name}
                            </CardTitle>
                            <p className="text-sm sm:text-base text-muted-foreground mt-1 line-clamp-2 px-4 sm:px-0">
                      ...
                      .map((character) => (
                        ...
                        >
                          <CardHeader className="flex flex-row items-center space-y-0 p-0 mb-3">
                            ...
                            <CardTitle className="text-lg sm:text-xl ml-3 truncate flex-1">
                              {character.name}
                            </CardTitle>
                          </CardHeader>
